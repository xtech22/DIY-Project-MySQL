...
public class Projects3 {
	...
	private Project3Service projectService = new Project3Service();
	...
	public static void main(String[] args) {
		new Projects3().processUserSelections();
			...
			private void updateProjectDetails() {
				...
				Project3Service.modifyProjectDetails(project);
				curProject = Project3Service.fetchProjectById(curProject.getProjectId());
